            ...
            <td>
                <table border="0" cellpadding="15"
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="#Profiles" style="text-decoration:none">
                                <font face="Verdana" size="5" color=black>
                                    Profiles
                                </font>
                            </a>
...
<video src="./xxx.mp4" muted loop autoplay></video>
...
<div class="about">
    <div class="h11">
    <h1 style="text-align: center;" >Hi ! Welcome to my Portfolio !</h1>
</div>
    <br>
<h1 style="text-align: center; text-decoration:dashed;" >About me</h1>
<h2> Thanks for your interest, here
            ...
            <td>
                <table border="0" cellpadding="15"
                    ...
                    <tr>
                        ...
                        <td width="45%">
                            <img src="./image 1.jpg" alt="Project" width="75%">
                        </td>
                    </tr>
                </table>
            </td>
 ...
 <div class="profile">
    ...
    <table id="Profiles" border="0" width="100%"
                        ...
                        <td width="10%">
                            <font face="arial" color="black" size="5">
                                <a href="#header" style="text-decoration:none">
                                    <font face="Verdana"  color="#000000" size="5">
                                        <button type="TOP ☝">
                                        <b>TOP ☝</b>
                                    </font>
                                </a>
